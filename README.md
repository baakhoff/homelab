...
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) | An AI agent with memory, skills and scheduled tasks, run from its web dashboard. |
...
- **node02, node03, node04** — k3s with embedded etcd, all three as servers,
  ...
  ([how](clusters/lab/hermes/README.md)). Nightly restic backup of its volumes
